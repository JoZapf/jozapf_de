<?php
/**
 * Contact Form PHP Handler - Production Version with Sender Confirmation
 * 
 * @author JoZapf
 * @version 2.3.0
 * @date 2025-10-02
...
$confirmHeaders = [
    'From: ' . $from,
    'Reply-To: ' . $to,  // Reply to site owner
    'X-Mailer: PHP/' . phpversion(),
    'MIME-Version: 1.0',
    'Content-Type: text/html; charset=UTF-8'
];

$confirmSubject = 'Thank you for your message through www.jozapf.de';
...
<head>
    ...
    <style>
        ...
        .message { margin: 20px 0; padding: 20px; background: white; border-left: 4px solid #27ae60; }
...
<body>
    <div class='container'>
        ...
        <div class='content'>
            ...
            <p>Thank you for contacting me through jozapf.de!</p>
            ...
            <p>Best regards,<p>
            <p><strong>Jo Zapf</strong><br>
            <a href='https://jozapf.de'>jozapf.de</a></p>
            
            <div class='footer'>
                This is an automated confirmation email. Please do not reply to no-reply@jozapf.de.<br>
            </div>
        </div>
    </div>
</body>
...
// Also log confirmation email
$confirmFilename = "confirmation-{$timestamp}-{$uniqueId}.eml";
$confirmEmlContent = "From: {$from}\r\n";
$confirmEmlContent .= "To: {$email}\r\n";
$confirmEmlContent .= "Reply-To: {$to}\r\n";
$confirmEmlContent .= "Subject: {$confirmSubject}\r\n";
$confirmEmlContent .= "Date: " . date('r') . "\r\n";
$confirmEmlContent .= "MIME-Version: 1.0\r\n";
$confirmEmlContent .= "Content-Type: text/html; charset=UTF-8\r\n";
$confirmEmlContent .= "\r\n";
$confirmEmlContent .= $confirmBody;

file_put_contents($logDir . '/' . $confirmFilename, $confirmEmlContent);
