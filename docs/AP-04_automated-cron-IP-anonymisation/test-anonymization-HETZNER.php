...
<?php
/**
 * Test Script for Anonymization Cronjob (Hetzner Structure)
 * 
 * Purpose: Verify the anonymization script works correctly before setting up cronjob
 * 
 * LOCATION: /usr/home/jozapf/cron/contactform/test-anonymization.php
 * 
 * Usage:
...
printHeader("ContactForm GDPR Anonymization - Test Script (Hetzner)");
...
if (is_dir(PROJECT_ROOT)) {
    ...
    printInfo("Expected: " . PROJECT_ROOT);
    printWarning("You may need to adjust USER_HOME or PROJECT_ROOT constants in this script");
    $allTestsPassed = false;
}
...
if ($allTestsPassed) {
    ...
    printInfo("   0 3 * * * php8.3 /usr/home/jozapf/cron/contactform/anonymize-logs.php");
    ...
    printInfo("4. Check if project paths are correct (USER_HOME, PROJECT_ROOT)");
    printInfo("5. Check README.md for detailed setup instructions");
    echo "\n";
    exit(1);
}
